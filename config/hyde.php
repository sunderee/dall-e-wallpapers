...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'DALL-E Wallpapers'),
    ...
    */
    ...
    'rss' => [
        ...
        'description' => env('SITE_NAME', 'DALL-E Wallpapers').' RSS Feed',
    ],
    ...
    */
    ...
    'meta' => [
        Meta::name('author', 'Peter Aleksander Bizjak'),
        Meta::name('twitter:creator', '@peteralexbizjak'),
        Meta::name('description', 'Collection of wallpapers I have asked DALL-E to generate for me'),
        Meta::name('keywords', 'AI Wallpapers, DALL-E, GPT'),
        Meta::name('generator', 'HydePHP v'.Hyde\Hyde::version()),
        Meta::property('site_name', env('SITE_NAME', 'DALL-E Wallpapers')),
    ],
    ...
    */
    ...
    'authors' => [
        Author::create(
            'peteraleksanderbizjak',
            'Peter Aleksander Bizjak', 
            'https://sunderee.github.io' 
        ),
    ],
    ...
    */
    ...
    'footer' => 'Wallpapers generated with ❤️ + 🤖 + ☕️. Brought to you by [HydePHP](https://github.com/hydephp/hyde) 🎩',
